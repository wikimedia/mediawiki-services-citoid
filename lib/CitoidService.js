...
class CitoidService {
    ...
    */
    requestFromDOI(citation, cr) {
        this.logger.log('trace/CitoidService', "requestFromDOI method");
        ...
        //  Zotero
        const onResolve = (cr) => {
            this.logger.log('trace/zotero', "Successfully retrieved body from Zotero");
            return cr;
        };
        ...
        const fromURL = unshorten(doiLink, this.userAgent, cr.jar, this.conf, this.logger)
            .then((expandedURL) => {
        ...
        if (this.conf.zotero) {
            ...
            .catch((error) => {
                this.logger.log('warn/zotero', error);
    ...
    */
    requestFromPM(citation, cr) {
        this.logger.log('trace/CitoidService', "requestFromPM method");
        citation.format = cr.format;
    ...
    */
    requestFromURL(citation, cr, reqDOI) {
        this.logger.log('trace/CitoidService', "requestFromURL method");
        citation.format = cr.format;
        citation.doi = citation.doi || cr.doi;
        reqDOI = reqDOI || false;
    ...
    */
    requestFromSearch(citation, cr) {
        this.logger.log('trace/CitoidService', "requestFromSearch method");
        citation.format = cr.format;
    ...
    */
    requestToWSKEY(citation, cr) {
        this.logger.log('trace/CitoidService', "requestToWSKEY method");
        citation.format = cr.format;
        citation.doi = cr.doi;
    ...
    */
    requestToZotISBN(citation, cr) {
        this.logger.log('trace/CitoidService', "requestToZotISBN method");
        citation.format = cr.format;
        citation.doi = cr.doi;
        ...
        return this.zoteroService.zoteroSearchRequest(citation.isbn, cr, citation).then(
            ...
            // Rejection handler
            () => {
                this.logger.log('warn/zotero', `Unable to retrieved metadata from ISBN ${citation.isbn} from Zotero`);
