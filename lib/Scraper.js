    ...
    return preq({
        ...
        if (!response || response.status !== 200) {
            ...
            if (chtml){
                ...
                return citationPromise.then(function(citation){
                    return scraper.parseHTML(citationObj, cr, chtml).then(
...
/**
 * Create 404 citation- creates 200 if crossRef succeeds
 ...
 */
var build404 = BBPromise.method(function(citationObj, cr){
