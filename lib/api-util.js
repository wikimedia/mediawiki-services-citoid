 ...
 * @param {string} domain the domain to issue the request to
 * @param {?Object} query an object with all the query parameters for the MW API
 * @param {!Array.string} titles list of titles to request by batch
 * @param {?number} size number of titles to request per batch
 * @return {!Array.Object} combined results of the batched queries
 */
 ...
 * @return {Response} query succeeded
 */
