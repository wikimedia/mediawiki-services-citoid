 ...
 * @param  {String}  identifier  Valid PubMed identifier (DOI, PMID, PMCID with PMC prefix, Manuscript ID, versioned ID)
...
var pubMedRequest = function (identifier, userAgent, logger){
    ...
    var url = "https://www.ncbi.nlm.nih.gov/pmc/utils/idconv/v1.0/?tool=citoid&email=citoid@mediawiki&format=json&ids=" + escapedId;
