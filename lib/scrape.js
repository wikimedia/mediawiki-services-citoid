	...
	request(
		{
			...
			if (error || !response || response.statusCode !== 200) {
				...
				try {
					...
					citation.title = null;
					exports.parseHTML(url, chtml, citation, function(citation){
						citation = citation;
...
exports.parseHTML = function(url, chtml, citation, callback){
	...
	if (typeTranslator){
		citation = exports.translate(citation, metaData.openGraph, typeTranslator);
	}
...
if (require.main === module) {
	...
	var $ = cheerio.load(fs.readFileSync('./node_modules/html-metadata/test_files/turtle_movie.html'));
