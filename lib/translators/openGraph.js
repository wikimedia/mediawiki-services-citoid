...
const makeTranslator = require('./util/index.js').makeTranslator;
...
exports.types = {
    website: 'webpage',
    // Previously blogPost, could also be newspaperArticle or magazineArticle
...
exports.general = {
    ...
    // general OG property, abstractNote common to all Zotero types
...
exports.webpage = Object.assign({}, exports.generalWithDate, {
    // prefix og: general property, but should only be assigned if type webpage is used
    site_name: makeTranslator('websiteTitle')
});
